...
from yolov2_config import YOLO
...
if __name__ == '__main__':
    ...
    net = build_yolov2(cls_num, anchor_wh, featmap_size, do_detect=False, pretrained=pretrained)
    if epochs_start > 0:
        net.load_state_dict(torch.load(savedir + 'model_208.pkl'))
    net.cuda()
    net.train()

    encoder = group_encoder(anchor_wh, cls_num, featmap_size)#yolo_box_encoder
